...
window.CROMA_TEXT = {
  en: {
    ...
    modularField: 'MODULAR FIELD', acousticField: 'ACOUSTIC FIELD',
    ...
    instruction: 'Press Play and move the balance.',
  ...
  ru: {
    ...
    modularField: 'МОДУЛЬНОЕ ПОЛЕ', acousticField: 'АКУСТИЧЕСКОЕ ПОЛЕ',
    ...
    instruction: 'Нажмите «Играть» и двигайте баланс.',
